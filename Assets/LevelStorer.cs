...
/*		reset = PlayerPrefs.GetInt ("Reset");
		...
		leveldic.Add (101, lv1);
		leveldic.Add (102, lv2);
		leveldic.Add (103, lv3);
		leveldic.Add (104, lv4);
		leveldic.Add (105, lv5);
		leveldic.Add (106, lv6);
		leveldic.Add (107, lv7);
		leveldic.Add (108, lv8);
		leveldic.Add (109, lv9);
		leveldic.Add (110, lv10);
		leveldic.Add (111, lv11);
		leveldic.Add (112, lv12);
		leveldic.Add (113, lv13);
		leveldic.Add (114, lv14);
		leveldic.Add (115, lv15);
		leveldic.Add (116, lv16);
		leveldic.Add (117, lv17);
		leveldic.Add (118, lv18);
		leveldic.Add (119, lv19);
		leveldic.Add (120, lv20);
		leveldic.Add (121, lv21);
		leveldic.Add (122, lv22);
		leveldic.Add (123, lv23);
		leveldic.Add (124, lv24);
		leveldic.Add (125, lv25);
		leveldic.Add (126, lv26);
		leveldic.Add (127, lv27);
		leveldic.Add (128, lv28);
		leveldic.Add (129, lv29);
		leveldic.Add (130, lv30);
		leveldic.Add (131, lv31);
		leveldic.Add (132, lv32);
		leveldic.Add (133, lv33);
		leveldic.Add (134, lv34);
		leveldic.Add (135, lv35);
		leveldic.Add (136, lv36);
		leveldic.Add (137, lv37);
		leveldic.Add (138, lv38);
		leveldic.Add (139, lv39);
		leveldic.Add (140, lv40);
		leveldic.Add (141, lv41);
		leveldic.Add (142, lv42);
		leveldic.Add (143, lv43);
		leveldic.Add (144, lv44);
		leveldic.Add (145, lv45);
		leveldic.Add (146, lv46);
		leveldic.Add (147, lv47);
		leveldic.Add (148, lv48);
		leveldic.Add (149, lv49);
		leveldic.Add (150, lv50);
		leveldic.Add (151, lv51);
		leveldic.Add (152, lv52);
		leveldic.Add (153, lv53);
		leveldic.Add (154, lv54);
		leveldic.Add (155, lv55);
		leveldic.Add (156, lv56);
		leveldic.Add (157, lv57);
		leveldic.Add (158, lv58);
		leveldic.Add (159, lv59);
		leveldic.Add (160, lv60);
		leveldic.Add (161, lv61);
		leveldic.Add (162, lv62);
		leveldic.Add (163, lv63);
		leveldic.Add (164, lv64);
		leveldic.Add (165, lv65);
		leveldic.Add (166, lv66);
		leveldic.Add (167, lv67);
		leveldic.Add (168, lv68);
		leveldic.Add (169, lv69);
		leveldic.Add (170, lv70);
		leveldic.Add (171, lv71);
		leveldic.Add (172, lv72);
		leveldic.Add (173, lv73);
		leveldic.Add (174, lv74);
		leveldic.Add (175, lv75);
		leveldic.Add (176, lv76);
		leveldic.Add (177, lv77);
		leveldic.Add (178, lv78);
		leveldic.Add (179, lv79);
		leveldic.Add (180, lv80);
		leveldic.Add (181, lv81);
		leveldic.Add (182, lv82);
		leveldic.Add (183, lv83);
		leveldic.Add (184, lv84);
		leveldic.Add (185, lv85);
		leveldic.Add (186, lv86);
		leveldic.Add (187, lv87);
		leveldic.Add (188, lv88);
		leveldic.Add (189, lv89);
		leveldic.Add (190, lv90);
		leveldic.Add (191, lv91);
		leveldic.Add (192, lv92);
		leveldic.Add (193, lv93);
		leveldic.Add (194, lv94);
		leveldic.Add (195, lv95);
		leveldic.Add (196, lv96);
		leveldic.Add (197, lv97);
		leveldic.Add (198, lv98);
		leveldic.Add (199, lv99);
		leveldic.Add (200, lv100);
